export const ERROR_MESSAGE = {
  ...
  INVALID_EMAIL_FORMAT: '아이디는 이메일 형식 입니다',
  INVALID_PASSWORD_FORMAT: '영문자, 숫자, 특수문자를 포함한 8자 이상으로 작성해주세요',
...
export const PLACEHOLDER = {
  ...
  ADD_LINK: '링크를 추가해 보세요',
  SEARCH_LINK: '링크를 검색해 보세요',
};

export const MESSAGE = {
  EMPTY_KEYWORD: '검색결과가 없습니다.',
  EMPTY_CARD: '저장된 링크가 없습니다.',
  ADD_LINK: '링크가 추가되었습니다.',
  DELETE_LINK: '링크가 삭제되었습니다.',
